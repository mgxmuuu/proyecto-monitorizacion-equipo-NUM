...
Esto significa que el Exporter está encendido, escuchando en el puerto 9256 y leyendo los procesos de /proc. Por defecto, expone métricas en: http://localhost:9256/metrics
...
Abrimos Prometheus en http://localhost:9090 y probamos una consulta como:
```bash
